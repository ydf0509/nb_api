...
HOST = os.getenv('TENXUNYUN__HOST')
PORT = 22
USER = os.getenv('TENXUNYUN__USER')
PASSWORD = os.getenv('TENXUNYUN__PASSWORD')

PYTHON_INTERPRETER = '/data/miniconda3/envs/py39/bin/python'  # 如果你安装了四五个python环境，可以直接指定远程解释器的绝对路径  例如 /opt/minicondadir/ens/env35/python
